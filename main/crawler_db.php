...
<select id="site" name="site">
	...
	<option value="shoes164">Antonia</option>
	...
	<option value="footwearuomo">Holypopstore</option>
	...
	<option value="footwear">OneblockdownFootwear</option>
	...
	<option value="sneakersusi">Susi</option>
	...
	<option value="sneakersvooberlin">Vooberlin</option>
